...
- The browser favicon uses a warm-white Agent orbit mark with a black precision core, two restrained orbit lines, and one `#e54e37` execution signal; it contains no text or decorative micro-detail so it remains legible at 16×16.
