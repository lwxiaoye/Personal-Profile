...
- In the expanded CareerForge-AI project card, keep the source-code link and route `前往体验` to `/career/`. Until later deployments exist, both `查看源码` and `前往体验` for 多智能体客服 point to `https://github.com/lwxiaoye/Agent-`, and both actions for 医疗 RAG point to `https://github.com/lwxiaoye/medical-RAG-`; external GitHub actions open in a new tab.
