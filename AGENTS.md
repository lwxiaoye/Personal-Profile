...
- In the expanded CareerForge-AI project card, keep the source-code link and add a clear `前往体验` action that routes to `/career/`; do not add live links for the service or medical projects until those deployments exist.
