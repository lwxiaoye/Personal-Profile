...
- The browser favicon uses the user-selected three-orbit master image: a warm-white Agent orbit mark with a black precision core, three black orbit lines, and one `#e54e37` warm-red signal; it contains no text or decorative micro-detail so it remains legible at 16×16.
